						...
						<div className='pt-4'>
							<div className='flex justify-between gap-4 items-center'>
								<div className='flex flex-1 gap-5'>
									<div className=''>
										<p className='font-light text-base'>Chi Yeu My Nhan</p>
					...
					<div className='absolute top-2 w-full'>
						...
						<div className='mt-2 px-4 relative'>
							<div className='w-[80%] h-7 bg-white'>
								<p className='text-black italic text-right pr-2'>108</p>
							</div>
						...
						<div className='mt-10 px-4 flex items-center gap-3'>
							<p className='text-2xl text-left'>My Nhan</p>
              <div>
                <p className='text-xs uppercase'>My Nhan Bank</p>
                <p className='text-xs uppercase'>My Nhan BankCard Center</p>
              </div>
						</div>
					</div>
				</div>
